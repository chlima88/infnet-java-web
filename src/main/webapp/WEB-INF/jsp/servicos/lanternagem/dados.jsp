...
<body>
	...
	<div class="container">
        ...
        <c:import url="/WEB-INF/jsp/header.jsp" >
            <c:param name="title" value="Informações do Servico Eletrico" />
        </c:import>	
        ...
        <form id="form" action="/lanternagem/atualizar" method="post">
                ...
                <div class="col mb-3">
                    ...
                    <div class="form-group">
                        <input
                            ...
                            type="radio"
                            name="tamanhoAvaria"
                            ${ servico.tamanhoAvaria == "P" ? 'checked' : '' }
                            disabled/>
                    ...
                    <div class="form-group">
                        <input
                            ...
                            type="radio"
                            name="tamanhoAvaria"
                            ${ servico.tamanhoAvaria == "G" ? 'checked' : '' }
                            disabled/>
            ...
            <a class="w-25 btn btn-primary read-edit" role="button" href="/lanternagem/listar" >Cancelar</a>
